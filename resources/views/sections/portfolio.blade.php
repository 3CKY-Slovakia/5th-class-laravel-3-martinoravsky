...
<section id="blog" class="container masonry-blog bl-4-col">
    ...
    <div id="blog-items" class="fullwidth">
        ...
        <div class="cbp-item item graphic">
            ...
            <a href="#" class="posted_button">
                <!-- Image SRC -->
                <img src="../images/user_02.jpg" alt="user">
                <p>
                    Posted By Doen
                    <span>@WebDesign</span>
                </p>
        ...
        <!-- Item -->
        <div class="cbp-item item graphic web">
            <!-- Item Image -->
            <div class="item-top">
                <!-- Post Link -->
                <a href="{{ url('blog-post', [1]) }}" class="ex-link item_image">
            ...
            <a href="#" class="posted_button">
                <!-- Image SRC -->
                <img src="../images/user_04.jpg" alt="user">
                <p>
                    Posted By Tom
                    <span>@WebDesign</span>
                </p>
        ...
        <!-- Item -->
        <div class="cbp-item item design graphic">
            <!-- Item Image -->
            <div class="item-top">
                <!-- Post Link -->
                <a href="{{ url('blog-post', [1]) }}" class="ex-link item_image">
        ...
        <!-- Item -->
        <div class="cbp-item item photography">
            <!-- Details -->
            <div class="details">
                <!-- Item Name -->
                <a href="{{ url('blog-post', [1]) }}" class="ex-link">
